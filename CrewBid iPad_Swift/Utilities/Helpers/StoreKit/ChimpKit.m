...
- (void)callApiMethod:(NSString *)method withParams:(NSDictionary *)params {
   ...
   // self.connection = [[NSURLConnection alloc] initWithRequest:request delegate:self];
    ...
    self.connection = [NSURLSession sessionWithConfiguration:[NSURLSessionConfiguration defaultSessionConfiguration]
                                                           delegate:self
                                                      delegateQueue:[NSOperationQueue mainQueue]];
    NSURLSessionDataTask *datatask = [self.connection dataTaskWithRequest:request];
    [datatask resume];
