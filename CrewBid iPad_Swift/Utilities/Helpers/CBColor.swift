...
class CBColor {
    ...
    static let brownColor = UIColor(red: 122.0 / kColorDivisor, green: 92.0 / kColorDivisor, blue: 49.0 / kColorDivisor, alpha: 1.0)
    static let oldbrownColor = UIColor(red: 153.0 / kColorDivisor, green: 102.0 / kColorDivisor, blue: 51.0 / kColorDivisor, alpha: 1.0)
    static let purpleColor = UIColor(red: 76.0 / kColorDivisor, green: 23.0 / kColorDivisor, blue: 203.0 / kColorDivisor, alpha: 1.0)
    static let lightBlackColor = UIColor(red: 27 / kColorDivisor, green: 28 / kColorDivisor, blue: 28 / kColorDivisor, alpha: 1.0)
    static let red = UIColor(red: 255.0 / kColorDivisor, green: 59.0 / kColorDivisor, blue: 10.0 / kColorDivisor, alpha: 1.0)
    static let orangeColor = UIColor(red: 220.0 / kColorDivisor, green: 100.0 / kColorDivisor, blue: 5.0 / kColorDivisor, alpha: 1.0)
    static let gray = UIColor(red: 124.0 / kColorDivisor, green: 138.0 / kColorDivisor, blue: 150.0 / kColorDivisor, alpha: 1.0)
    static let greenColor = UIColor(red: 0.0, green: 0.6484375, blue: 0.484375, alpha: 1.0)
